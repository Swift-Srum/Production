...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($northings) && !empty($eastings) && !empty($postcode) && !empty($man_details) && !empty($model) && !empty($serial) && !empty($notes) && !empty($capacity) && !empty($length) && !empty($width) && !empty($height) && !empty($weight_empty) && !empty($weight_full) && !empty($supplier) && !empty($date_received) && !empty($date_returned)) {
