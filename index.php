...
<div>
    <div class="top"></div>
    <div class="text"><h1>Bowsers Prototype</h1></div>
    <div class="content">
        <div class="mainHeader">
            <div class="mainHeaderText">
                <div class="HeaderText"Bowsers Prototype</div>
                <div class="HeaderText textPurple">More text can go here</div>
            </div>
        </div>
        <div class="products">
            <div class="product">
                <img src="/assets/back.jpg" alt="Product Image" class="productImage"/>
                <div class="productTitle">Bowsers Prototype</div>
                ...
                <div onclick="location.href = 'lol';" class="getAccessBtn">More info</div>
        </div>
    </div>
</div>
